...
class ModelAccount extends AbstractModel{
    ...
    public function setId(?int $id): ModelAccount { $this->id = $id; return $this; }

    public function getAccount(): ?array { return $this->account; }
    public function setAccount(?array $account): ModelAccount { $this->account = $account; return $this; }

    public function getEmail(): ?string { return $this->email; }
    public function setEmail(?string $email): ModelAccount { $this->email = $email; return $this; }
